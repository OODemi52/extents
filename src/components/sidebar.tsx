...
export function Sidebar() {
  ...
  return (
    <aside className="w-full h-full border border-zinc-700/50 shadow-[2px_4px_16px_0px_rgba(248,248,248,0.06)_inset] bg-[rgba(30,30,30,0.99)] rounded-3xl flex flex-col pl-2 p-2 gap-y-1 overflow-scroll overflow-x-hidden">
