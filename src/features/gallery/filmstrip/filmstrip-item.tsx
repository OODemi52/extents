...
export const FilmstripItem = forwardRef<HTMLDivElement, FilmstripItemProps>(
  ({ file, index, isSelected, size, density, onSelect }, ref) => {
    ...
    return (
      <Card
        ...
        className="group relative h-full w-full bg-transparent p-0 shadow-none rounded-none focus:outline-none"
        role="option"
      ...
      >
        ...
        {(showRating || showFlags) && (
          <CardFooter
            className={`pointer-events-none absolute inset-x-0 bottom-1 flex items-center justify-center gap-1 px-0 py-0 transition-opacity duration-150 ${
